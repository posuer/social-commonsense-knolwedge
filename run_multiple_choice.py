...
def main():
    ...
    additional_special_tokens = q2rel_special_tokens if data_args.task_name in ["socialiqa_q2rel", "socialiqa_q2rel_category", "socialiqa_q2rel_rand"] else []
    if data_args.task_name in ["socialiqa_category", "socialiqa_q2rel_category", "socialiqa_category_rand" ]:
            ...
            with open(output_eval_file, "w") as writer:
                ...
                if test_dataset or eval_dataset:
                    ...
                    if test_dataset:
                        ...
                        f = open(os.path.join(training_args.output_dir, f"best_test_{test_acc:.4f}.txt"),'w')
                        f.close()
